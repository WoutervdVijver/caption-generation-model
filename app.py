...
def index():
    ...
    if request.method == 'POST':
        ...
        if 'file' not in request.files:
            return render_template('index.html', text = 'No file was found. Please upload a picture')
        ...
        return render_template('index.html', text = 'Please upload a picture in .jpg format')
